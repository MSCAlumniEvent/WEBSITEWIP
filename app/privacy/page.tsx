  ...
  return (
    <section className="py-24 sm:py-32">
      <div className="max-w-3xl mx-auto px-6 lg:px-8">
        ...
        <p className="text-navy/60 mb-12">As of: 20.02.2026</p>
        ...
        <div className="space-y-6 text-navy/80 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-navy pt-6">Definitions</h2>
          <p>
          ...
          <h3 className="text-xl font-bold text-navy pt-2">a) Personal data</h3>
          <p>
          ...
          <h3 className="text-xl font-bold text-navy pt-2">b) Data subject</h3>
          <p>
            Data subject is any identified or identifiable natural person, whose personal data is processed by the controller responsible for the processing.
          </p>

          <h3 className="text-xl font-bold text-navy pt-2">c) Processing</h3>
          <p>
            Processing is any operation or set of operations which is performed on personal data or on sets of personal data, whether or not by automated means, such as collection, recording, organisation, structuring, storage, adaptation or alteration, retrieval, consultation, use, disclosure by transmission, dissemination or otherwise making available, alignment or combination, restriction, erasure or destruction.
          </p>

          <h3 className="text-xl font-bold text-navy pt-2">d) Restriction of processing</h3>
          <p>
            Restriction of processing is the marking of stored personal data with the aim of limiting their processing in the future.
          </p>

          <h3 className="text-xl font-bold text-navy pt-2">e) Profiling</h3>
          <p>
          ...
          <h3 className="text-xl font-bold text-navy pt-2">f) Pseudonymisation</h3>
          <p>
            Pseudonymisation is the processing of personal data in such a manner that the personal data can no longer be attributed to a specific data subject without the use of additional information, provided that such additional information is kept separately and is subject to technical and organisational measures to ensure that the personal data are not attributed to an identified or identifiable natural person.
          </p>

          <h3 className="text-xl font-bold text-navy pt-2">g) Controller or controller responsible for the processing</h3>
          <p>
            Controller or controller responsible for the processing is the natural or legal person, public authority, agency or other body which, alone or jointly with others, determines the purposes and means of the processing of personal data; where the purposes and means of such processing are determined by Union or Member State law, the controller or the specific criteria for its nomination may be provided for by Union or Member State law.
          </p>

          <h3 className="text-xl font-bold text-navy pt-2">h) Processor</h3>
          <p>
            Processor is a natural or legal person, public authority, agency or other body which processes personal data on behalf of the controller.
          </p>

          <h3 className="text-xl font-bold text-navy pt-2">i) Recipient</h3>
          <p>
            Recipient is a natural or legal person, public authority, agency or another body, to which the personal data are disclosed, whether a third party or not. However, public authorities which may receive personal data in the framework of a particular inquiry in accordance with Union or Member State law shall not be regarded as recipients; the processing of those data by those public authorities shall be in compliance with the applicable data protection rules according to the purposes of the processing.
          </p>

          <h3 className="text-xl font-bold text-navy pt-2">j) Third party</h3>
          <p>
            Third party is a natural or legal person, public authority, agency or body other than the data subject, controller, processor and persons who, under the direct authority of the controller or processor, are authorised to process personal data.
          </p>

          <h3 className="text-xl font-bold text-navy pt-2">k) Consent</h3>
          <p>
            Consent of the data subject is any freely given, specific, informed and unambiguous indication of the data subject&rsquo;s wishes by which he or she, by a statement or by a clear affirmative action, signifies agreement to the processing of personal data relating to him or her.
          </p>
          ...
          <h2 className="text-2xl font-bold text-navy pt-6">Registration on our website</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-navy pt-6">Contact possibility via the website</h2>
          <p>
            The website contains information that enables a quick electronic contact to our enterprise, as well as direct communication with us, which also includes a general address of the so-called electronic mail (e-mail address). If a data subject contacts the controller by e-mail or via a contact form, the personal data transmitted by the data subject are automatically stored. Such personal data transmitted on a voluntary basis by a data subject to the data controller are stored for the purpose of processing or contacting the data subject. There is no transfer of this personal data to third parties.
          </p>

          <h2 className="text-2xl font-bold text-navy pt-6">Comments function in the blog on the website</h2>
          <p>
            We offer users the possibility to leave individual comments on individual blog contributions on a blog, which is on the website of the controller. A blog is a web-based, publicly-accessible portal, through which one or more people called bloggers or web-bloggers may post articles or write down thoughts in so-called blogposts. Blogposts may usually be commented by third parties.
          </p>
          <p>
            If a data subject leaves a comment on the blog published on this website, the comments made by the data subject are also stored and published, as well as information on the date of the commentary and on the user&rsquo;s (pseudonym) chosen by the data subject. In addition, the IP address assigned by the Internet service provider (ISP) to the data subject is also logged. This storage of the IP address takes place for security reasons, and in case the data subject violates the rights of third parties, or posts illegal content through a given comment. The storage of these personal data is, therefore, in the own interest of the data controller, so that he can exculpate in the event of an infringement. This collected personal data will not be passed to third parties, unless such a transfer is required by law or serves the aim of the defense of the data controller.
          </p>

          <h2 className="text-2xl font-bold text-navy pt-6">Routine erasure and blocking of personal data</h2>
          <p>
          ...
          <h3 className="text-xl font-bold text-navy pt-2">a) Right of confirmation</h3>
          <p>
            Each data subject shall have the right granted by the European legislator to obtain from the controller the confirmation as to whether or not personal data concerning him or her are being processed. If a data subject wishes to avail himself of this right of confirmation, he or she may, at any time, contact any employee of the controller.
          </p>

          <h3 className="text-xl font-bold text-navy pt-2">b) Right of access</h3>
          <p>
          ...
          <h3 className="text-xl font-bold text-navy pt-2">c) Right to rectification</h3>
          <p>
          ...
          <h3 className="text-xl font-bold text-navy pt-2">d) Right to erasure (Right to be forgotten)</h3>
          <p>
          ...
          <h3 className="text-xl font-bold text-navy pt-2">e) Right of restriction of processing</h3>
          <p>
          ...
          <h3 className="text-xl font-bold text-navy pt-2">f) Right to data portability</h3>
          <p>
          ...
          <h3 className="text-xl font-bold text-navy pt-2">g) Right to object</h3>
          <p>
          ...
          <h3 className="text-xl font-bold text-navy pt-2">h) Automated individual decision-making, including profiling</h3>
          <p>
            Each data subject shall have the right granted by the European legislator not to be subject to a decision based solely on automated processing, including profiling, which produces legal effects concerning him or her, or similarly significantly affects him or her, as long as the decision (1) is not necessary for entering into, or the performance of, a contract between the data subject and a data controller, or (2) is not authorised by Union or Member State law to which the controller is subject and which also lays down suitable measures to safeguard the data subject&rsquo;s rights and freedoms and legitimate interests, or (3) is not based on the data subject&rsquo;s explicit consent.
          </p>
          <p>
            If the decision (1) is necessary for entering into, or the performance of, a contract between the data subject and a data controller, or (2) it is based on the data subject&rsquo;s explicit consent, we shall implement suitable measures to safeguard the data subject&rsquo;s rights and freedoms and legitimate interests, at least the right to obtain human intervention on the part of the controller, to express his or her point of view and contest the decision.
          </p>
          <p>
          ...
          <h3 className="text-xl font-bold text-navy pt-2">i) Right to withdraw data protection consent</h3>
          <p>
          ...
          <h2 className="text-2xl font-bold text-navy pt-6">Legal basis for the processing</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-navy pt-6">The legitimate interests pursued by the controller or by a third party</h2>
          <p>
            Where the processing of personal data is based on Article 6(1) lit. f GDPR our legitimate interest is to carry out our business in favor of the well-being of all our employees and the shareholders.
          </p>

          <h2 className="text-2xl font-bold text-navy pt-6">Period for which the personal data will be stored</h2>
          <p>
            The criteria used to determine the period of storage of personal data is the respective statutory retention period. After expiration of that period, the corresponding data is routinely deleted, as long as it is no longer necessary for the fulfillment of the contract or the initiation of a contract.
          </p>

          <h2 className="text-2xl font-bold text-navy pt-6">Provision of personal data as statutory or contractual requirement</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-navy pt-6">Existence of automated decision-making</h2>
          <p>
            As a responsible company, we do not use automatic decision-making or profiling.
          </p>

          <h2 className="text-2xl font-bold text-navy pt-6">Google Tag Manager</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-navy pt-6">Google Maps</h2>
          <p>
            We use Google Maps from Google Inc. (1600 Amphitheater Parkway Mountain View, CA 94043, USA) on our website.
          </p>
          <p>
            By using the features of this map, data will be transmitted to Google. What data Google collects and how it uses this information can be found on{' '}
            <a href="https://www.google.com/intl/en/policies/privacy/" target="_blank" rel="noopener noreferrer" className="text-orange hover:underline">
