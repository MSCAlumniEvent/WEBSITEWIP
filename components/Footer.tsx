        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://tiktok.com/@msc_maastricht" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-orange transition-colors" aria-label="TikTok">
